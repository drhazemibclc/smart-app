...
[`RunnerConfig`](https://v2.tauri.app/reference/config/#runnerconfig) | `null`
...
See more: <[https://v2.tauri.app/develop/resources/](https://v2.tauri.app/develop/resources/)\>
...
[`ExportedFileAssociation`](https://v2.tauri.app/reference/config/#exportedfileassociation) | `null`
...
[`HandlerRank`](https://v2.tauri.app/reference/config/#handlerrank)
...
-   [`PreventOverflowMargin`](https://v2.tauri.app/reference/config/#preventoverflowmargin) Enable prevent overflow with a margin so that the window’s size + this margin won’t overflow the workarea
...
-   `"fluentOverlay"` Fluent UI style overlay scrollbars. **Windows Only** Requires WebView2 Runtime version 125.0.2535.41 or higher, does nothing on older versions, see [https://learn.microsoft.com/en-us/microsoft-edge/webview2/release-notes/?tabs=dotnetcsharp#10253541](https://learn.microsoft.com/en-us/microsoft-edge/webview2/release-notes/?tabs=dotnetcsharp#10253541)
...
-   [`V1Compatible`](https://v2.tauri.app/reference/config/#v1compatible) Generates legacy zipped v1 compatible updaters
...
Initialize the WebView with a custom data store identifier. This can be seen as a replacement for `dataDirectory` which is unavailable in WKWebView. See [https://developer.apple.com/documentation/webkit/wkwebsitedatastore/init(foridentifier:)?language=objc](https://developer.apple.com/documentation/webkit/wkwebsitedatastore/init\(foridentifier:\)?language=objc)
...
[`PreventOverflowConfig`](https://v2.tauri.app/reference/config/#preventoverflowconfig) | `null`
...
[`ScrollBarStyle`](https://v2.tauri.app/reference/config/#scrollbarstyle)
...
[`LogicalPosition`](https://v2.tauri.app/reference/config/#logicalposition) | `null`
...
---
Source: [Configuration](https://v2.tauri.app/reference/config/#appconfig\%3E)

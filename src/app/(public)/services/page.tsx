...
import { getRole, getRoleFromSession } from '../../../lib/auth-server';
...
const PEDIATRIC_SERVICES = [
  ...
  },
  {
    ...
    icon: '💉',
    features: ['CDC-recommended schedule', 'Vaccine safety counseling', 'Immunization records', 'Catch-up schedules']
  },
  {
    title: 'Sick Visits',
  ...
  },
  {
    ...
    icon: '🚑',
    features: ['24/7 availability', 'Pediatric emergency specialists', 'Child-friendly environment', 'Family support']
  }
] as const;
...
const LACTATION_SERVICES = [
  ...
  },
  {
    ...
    icon: '🌟',
    features: ['Tongue tie assessment', 'Specialized equipment', 'Alternative feeding methods', 'Medical coordination']
  },
  {
          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='mx-auto mt-6 max-w-3xl text-gray-600 text-lg md:text-xl'>
                Expert care for your child&apos;s health journey, from newborn through adolescence, with specialized
                lactation support for breastfeeding success.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='mx-auto mt-4 max-w-2xl text-gray-600 text-lg'>
                Comprehensive healthcare services tailored to meet the unique needs of children at every stage of
                development.
              </p>
            </div>
            ...
            <div className='mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
              {PEDIATRIC_SERVICES.map(service => (
                <div
                  className='group rounded-2xl bg-blue-50 p-6 transition-all hover:-translate-y-1 hover:shadow-lg'
                  key={service.title}
                >
        ...
        <section className='bg-white py-16 sm:py-20'>
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='mx-auto mt-4 max-w-2xl text-gray-600 text-lg'>
                Schedule an appointment or learn more about our comprehensive pediatric and lactation services.
              </p>

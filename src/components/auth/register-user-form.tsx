  ...
  return (
    <div className='fade-in slide-in-from-bottom-4 mx-auto w-full max-w-[400px] animate-in space-y-8 duration-500'>
      ...
      <div className='flex flex-col space-y-2 text-center md:text-left'>
        <h1 className='font-bold text-3xl text-slate-900 tracking-tight dark:text-white'>Create an account</h1>
      ...
      <Form {...form}>
        ...
        >
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className='group relative'>
                    <User className='absolute top-3 left-3 h-4 w-4 text-slate-400 transition-colors group-focus-within:text-primary' />
                    <Input
          ...
          <Button
            className='mt-2 h-11 w-full cursor-pointer font-semibold text-base shadow-lg shadow-primary/20 transition-all hover:shadow-primary/30'
            disabled={isLoading}
            type='submit'
          >
            {isLoading ? (
